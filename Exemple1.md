...
M(crm:E42_identifier) --> |crm:P168_is_defined_by| N(crm:E94_space_primitive<br>43.60149, 12.94398)
M(crm:E42_identifier) --> |crm:P2_has_type| O(crm:E55_type<br>coordonnées géographiques<br>aat:300387569)
